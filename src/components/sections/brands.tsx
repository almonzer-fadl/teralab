...
const Brands = () => {
  ...
  const platforms = [
    ...
    },
    {
      ...
      url: 'https://instagram.com/teralab',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {platforms.map((platform, index) => (
            <a
              ...
              className={`${platform.color} text-white rounded-lg p-8 text-center transition-all duration-300 hover:transform hover:scale-105 shadow-lg`}
            >
              <div className="flex flex-col items-center">
                ...
                <p className="text-white/80">
                  {t(`brands.${platform.name.toLowerCase()}.description`)}
                </p>
              </div>
            </a>
          ))}
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <div className="flex items-center gap-2 text-orange-500">
              ...
              <span>{t('brands.feature1')}</span>
            </div>
            <div className="flex items-center gap-2 text-orange-500">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
              <span>{t('brands.feature2')}</span>
            </div>
            <div className="flex items-center gap-2 text-orange-500">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
              <span>{t('brands.feature3')}</span>
            </div>
          </div>
        </div>
      </div>
